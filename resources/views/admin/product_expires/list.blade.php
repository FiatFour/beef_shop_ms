                ...
                <form action="" method="GET">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{ route('admin.product-expires.index') }}'"
                            ...
                            @if ($products->isNotEmpty())
                                @foreach ($products as $product)
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('admin.product-expires.edit', $product->id) }}">{{ $product->title }}</a></td>
                                        <td>{{ $product->price }}</td>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.product-expires.edit', $product->id) }}">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response['status'] == true) {
                            window.location.href = "{{ route('admin.product-expires.index') }}";
                        } else {
                            window.location.href = "{{ route('admin.product-expires.index') }}";
                        }
                    }

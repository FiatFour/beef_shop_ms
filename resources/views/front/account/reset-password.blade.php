            ...
            <div class="login-form">
                <form action="{{ route('front.processResetPassword') }}" method="post">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control @error('new_password') is-invalid @enderror"  placeholder="New Passowrd" value="{{ old('new_password') }}"
                             name="new_password">
                        @error('new_password')
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control @error('confirm_password') is-invalid @enderror"  placeholder="Confirm Passowrd"

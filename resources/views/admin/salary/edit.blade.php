                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="amount" id="amount" class="form-control"
                                        placeholder="Amount" value="{{ $salary->amount }}">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input autocomplete="off" type="text" name="start_work" id="start_work" class="form-control"
                                        placeholder="Start work" value="{{ $salary->start_work }}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input autocomplete="off" type="text" name="get_off" id="get_off" class="form-control"
                                        placeholder="Get off work" value="{{ $salary->get_off }}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input autocomplete="off" type="text" name="pay_date" id="pay_date" class="form-control"
                                        placeholder="Pay date" value="{{ $salary->pay_date }}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input {{ $salary->status == 1 ? 'checked' : '' }} class="form-check-input" type="radio" name="status" id="status"
                                                value="1">
                                            <label class="form-check-label">Pay</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input {{ $salary->status == 0 ? 'checked' : '' }} class="form-check-input" type="radio" name="status" id="status"
                                                value="0">
...
@section('customJs')
    <script>
        $("#salaryForm").submit(function(event) {
            ...
            $.ajax({
                url: "{{ route('admin.salaries.update', $salary->id) }}",
                type: 'put',

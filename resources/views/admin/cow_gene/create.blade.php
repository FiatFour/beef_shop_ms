...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="" id="createCowGeneForm" name="createCowGeneForm" method="POST">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
...
@section('customJs')
    <script>
        $("#createCowGeneForm").submit(function(event) {
            event.preventDefault();
            var element = $(this);
            $("button[type=submit]").prop('disabled', true);
            $.ajax({
                url: "{{ route('admin.cow-genes.store') }}",
                type: 'post',

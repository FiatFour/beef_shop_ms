			...
			<div class="row">
                ...
                <div class="col-lg-4 col-6">
					<div class="small-box card">
						...
						<a href="{{ route('admin.products.index') }}" class="small-box-footer text-dark">More info <i class="fas fa-arrow-circle-right"></i></a>
					</div>
				</div>
				...
				<div class="col-lg-4 col-6">
					<div class="small-box card">
						...
						<a href="{{ route('admin.customers.index') }}" class="small-box-footer text-dark">More info <i class="fas fa-arrow-circle-right"></i></a>
					</div>
				</div>

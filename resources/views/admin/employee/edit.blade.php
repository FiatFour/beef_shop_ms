                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="phone" id="phone" class="form-control"
                                        placeholder="Phone" maxlength="10" value="{{ $employee->phone }}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="department" id="department" class="form-control"
                                        placeholder="Department" value="{{ $employee->department }}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="address" id="address" cols="30" rows="7" class="form-control">{{ $employee->address }}</textarea>
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input {{ ($employee->gender == 1) ? 'checked' : '' }} class="form-check-input" type="radio" name="gender" id="gender"
                                                value="1">
                                            <label class="form-check-label">Man</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input {{ ($employee->gender == 2) ? 'checked' : '' }} class="form-check-input" type="radio" name="gender" id="gender"
                                                value="2">

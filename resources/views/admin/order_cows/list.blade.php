                ...
                <form action="" method="GET">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{ route('admin.order-cows.index') }}'"
                                    ...
                                    @if ($orderDetailsWithRelations->isNotEmpty())
                                        @foreach ($orderDetailsWithRelations as $orderDetails)
                                            <tr>
                                                ...
                                                <td>{{ $orderDetails->order_cow_id }}</td>
...
@section('customJs')
    <script>
        function deleteRecord(id) {
            var url = "{{ route('admin.order-cows.delete', 'ID') }}"

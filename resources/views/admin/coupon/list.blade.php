        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('admin.coupons.create') }}" class="btn btn-primary">New Discount Coupon</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                            ...
                            @if ($discountCoupons->isNotEmpty())
                                @foreach ($discountCoupons as $discountCoupon)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.coupons.edit', $discountCoupon->id) }}">
                                            ...
                                            <a href="#" onclick="deleteRecord({{ $discountCoupon->id }})"
...
@section('customJs')
    <script>
        function deleteRecord(id) {
            var url = "{{ route('admin.coupons.delete', 'ID') }}"

                            ...
                            @if ($cows->isNotEmpty())
                                @foreach ($cows as $cow)
                                    <tr>
                                        ...
                                        <td>{{ number_format($cow->weight, 2) }} kg.</td>
                                        <td>{{ number_format($cow->height, 2) }} cm.</td>
                                        <td>
                                            @if ($cow->gender == 'Man')
                                                Man
                                            @else
                                        ...
                                        <td>{{ number_format($cow->dissect_total_kg, 2) }} kg.</td>
                                        <td>
                                            {{ !empty($cow->dissect_date) ? number_format($cow->costOfFood(), 2) : '' }}฿
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="deleteRecord({{ $cow->id }})"
